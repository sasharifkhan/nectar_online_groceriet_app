...
class ProductItemsGridview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(height: 250, child: GridView.builder(itemCount: 5,padding: EdgeInsets.all(10), scrollDirection: Axis.horizontal, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(mainAxisExtent: 174, mainAxisSpacing: 15, crossAxisCount: 1), itemBuilder: (context, index) => Container(
            height: 250,
